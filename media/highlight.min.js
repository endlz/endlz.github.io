...
className:"number",begin:"\\b\\d+",relevance:0},t]}}})());hljs.registerLanguage("nginx",(()=>{"use strict";function e(e){
return n("(?=",e,")")}function n(...e){return e.map((e=>{
return(n=e)?"string"==typeof n?n:n.source:null;var n})).join("")}return a=>{
...
end:"\\)"}]},{className:"symbol",begin:/<[\w-]+>/}]})})());hljs.registerLanguage("makefile",(()=>{"use strict";return e=>{const i={
...
className:{1:"keyword",3:"title.class"}}])}}})());hljs.registerLanguage("vbnet",(()=>{"use strict";function e(e){
return e?"string"==typeof e?e:e.source:null}function n(...n){
...
},n.inherit(s,{relevance:0})]}}})());hljs.registerLanguage("sql",(()=>{"use strict";function e(e){
...
begin:"\\b("+e.join("|")+")\\b"}]};var s}})());hljs.registerLanguage("nim",(()=>{"use strict";return e=>({name:"Nim",keywords:{
...
begin:/\b(\d[_\d]*)('?[iIuUfF](8|16|32|64))?/}]},e.HASH_COMMENT_MODE]})})());hljs.registerLanguage("csharp",(()=>{"use strict";return e=>{const n={
